...
<center>
	...
	<div class="grid items-center justify-center">
		<div class="leaderstatHolder">
			<button class="homeWidget bg-primaryLight dark:bg-primaryDark"> <a href="/user/leaderboard">
			...
			<button class="homeWidget bg-primaryLight dark:bg-primaryDark"> <a href="/user/shop">
				<h1 class="standoutText color-black dark:color-white">
					SHOP
				</h1>
				<div class="svgHolder bg-backgroundLight dark:bg-backgroundDark">
